...
st.markdown("<h1 style='text-align: center; color: #FFFFFF;'>Develop an AI-powered App for Predictive Modeling and Forecasting of Malaria Prevention in Liberia</h1>",
